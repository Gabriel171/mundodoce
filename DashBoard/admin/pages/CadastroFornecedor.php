                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="Envia_CFO.php" method="get">
                                        <div class="form-group">
                                            <label>Nome da Empresa</label>
                                            <input type="text" class="form-control" placeholder="Insira o nome da sua empresa" id="nomeempresa" name="nomeempresa" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Endereço da Empresa</label>
                                            <input type="text" class="form-control" placeholder="Insira o endereço da empres" id="enderecoempresa" name="enderecoempresa" required>
                                        </div>
                                         <div class="form-group">
                                            <label>Cidade</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Insira o seu CGC/CNPJ" id="cgc" name="cgc" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Pessoa do Contato</label>
                                            <input type="text" class="form-control" placeholder="Insira o nome de contato" id="pessoacontato" name="pessoacontato" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Telefone Comercial</label>
                                            <input type="text" class="form-control" placeholder="Insira o seu telefone" id="telefonecomercial" name="telefonecomercial" required>
                                        </div>
                                        <div class="form-group">
                                            <label>E-mail</label>
                                        ...
                                        <div class="form-group">
                                            <label>Agencia</label>
                                            <input type="text" class="form-control" placeholder="Insira a sua agencia" id="agencia" name="agencia" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Conta</label>
                                            <input type="text" class="form-control" placeholder="Insira a sua conta" id="conta" name="conta" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Estado</label>
